	...
	$sql1 = "insert into admin set  Name='$name', Email='$email', User_ID='$user_id', Password='$pass'";
	//echo $sql; die;
        ...
        <div id="login">   
          ...
          <form action="" method="post" name= "update" onsubmit="return checkForm(this);">
           ...
           <div class="field-wrap">
            ...
            <input type="text" required autocomplete="off"/ name="name" placeholder="Enter Name">
           </div>
              <div class="field-wrap">
		  <h3 class="lable">Email</h3>
            <input type="text" required  autocomplete="off"/ name="email" placeholder="Enter Your Email">
          </div>
		  <div class="field-wrap">
			<h3 class="lable">User Id</h3>
            <input type="text" required autocomplete="off"/ name="user_id" placeholder="Set User Id">
           </div>
          <div class="field-wrap">
		  ...
		  <h3 class="lable">Confirm Password</h3>
            <input type="password" required  autocomplete="off"/ name="cpassword" placeholder="Confirm Your Password">
          </div>
