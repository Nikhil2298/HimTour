...
<center><h2 class="heading"><font face="cooper">Customer</font></h2></center>
<br>
...
<?php
	...
	while($result =mysqli_fetch_array($query))
	{
		...
		?>
<tr>
<td class="table1"> <?php echo $tourist_id ?> </td>
<td class="table1"> <?php echo $result ['First_Name']." ".$result['Last_Name']; ?> </td>
<td class="table1"> <?php echo $result ['Email'] ?> </td>
<td class="table1"> <?php echo $result ['Phone_no'] ?> </td>
<td class="table1"> <?php echo $result ['dob'] ?></td>
<td class="table1"> <?php echo $result ['Address'] ?> </td>
<td class="table1"> <?php echo $result ['User_ID'] ?> </td>

<!-- <td><a href="delete_record.php?id=<?php echo $book_id; ?>">Delete</a>&nbsp;&nbsp;<a href="update_record.php?id=<?php echo $book_id; ?>">update</a></td> -->
</tr>
	<?php } ?>
</table>
</div>
